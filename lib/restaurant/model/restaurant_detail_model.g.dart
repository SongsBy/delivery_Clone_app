...
RestaurantDetailModel _$RestaurantDetailModelFromJson(
    ...
    RestaurantDetailModel(
      ...
      priceRange: $enumDecode(_$RestaurantPriceRageEnumMap, json['priceRange']),
...
Map<String, dynamic> _$RestaurantDetailModelToJson(
    ...
    <String, dynamic>{
      ...
      'tags': instance.tags,
      'priceRange': _$RestaurantPriceRageEnumMap[instance.priceRange]!,
...
const _$RestaurantPriceRageEnumMap = {
  RestaurantPriceRage.expensive: 'expensive',
  RestaurantPriceRage.medium: 'medium',
  RestaurantPriceRage.cheap: 'cheap',
};
